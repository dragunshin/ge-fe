  ...
  return (
    <div className="flex h-full flex-col bg-white">
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="pt-6">
          {/* header */}
          <header className="app-header flex items-center px-1 py-2 ml-3 bg-white">
            <button onClick={() => navigate(-1)} className="mr-3">
              <Back className="w-[18px] h-[18px]" />
            </button>
            <h1 className="pre_title_semi_20">포인트</h1>
          </header>
            ...
            <section className="px-5 pt-5">
              <div className="relative rounded-[12px] bg-[#E5F4FF] px-4 py-4">
                ...
                <div className="mt-4 flex items-end justify-between gap-3">
                  <div>
                    <p className="text-[14px] font-semibold text-neutral-900">
                      포인트 적립 <span className="text-[14px] font-bold text-[#008bff]">500P</span>
                    </p>
